...
- [ANP Profile 3: Direct Messaging Base Semantics](/message/03-direct-messaging-base-semantics.md)
- [ANP Profile 4: Group Messaging Base Semantics](/message/04-group-messaging-base-semantics.md)
- [ANP Profile 5: Direct End-to-End Encryption](/message/05-direct-end-to-end-encryption.md)
