...
- 状态：草案 / 未发布
- 英文镜像：[Native did:web Integration](../../vnext/appendix-b-compatibility-with-native-did-web.md)
- 历史基线：[已发布兼容附录](../附录B：与原生did-web-的兼容.md)，保留原文
...
| 消息身份、设备与服务 | [消息 P2](../message/vnext/02-身份与发现.md) |
| 原发者与对象证明绑定 | [消息 P1](../message/vnext/01-核心绑定.md) |
