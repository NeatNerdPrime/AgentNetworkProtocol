...
* [ANP-02](../../vnext/02-ANP-基于DID的身份认证协议.md)：通用身份输入、认证密钥授权、签名参数安全、时间与重放要求；适用方法绑定拥有 Document 验证
...
- 身份材料按 [P2 方法验证合同](02-身份与发现.md#method-validation)及适用方法绑定验证；WBA 的特有规则仍由 [ANP-03 方法条款](../../vnext/03-did-wba方法规范.md#wba-method-rules)拥有，不复制到对象证明算法。
