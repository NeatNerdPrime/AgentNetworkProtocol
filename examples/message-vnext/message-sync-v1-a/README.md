...
- `lane-handoff-fixtures.json`: serialized P5/P6 envelopes and the required duplicate, conflict, limit, rollback, lost-response, and consumer-boundary scenarios.
